...
shinyUI(
  navbarPage(title = "TEAM RUN",
             ...
             tabPanel("Conclusion",
                      titlePanel("Answering the Questions"),
                      mainPanel(
                        tags$br(),
                        tags$div(
                          ...
                          tags$p("From our scatter plot tab we are able to filter through four different options that may affect student performance. 
                                 ...
                                 leads to a higher density of students plotted along the lower tiered performance. 
                                 For example, selecting the default option of raised hands on the x-axis you can see a clear visual of the students who raised their hands less are populating the performance rating of 1.
                                 It is less clear that higher frequencies of these tasks directly translate to higher tiered performance level, but applying extra filters can show more prominent evidence.
                                 We also claim that correlation does not mean causation and there could be multiple factors that affect performance."),
                          tags$h3("Does a specific gender tend to be more influenced by the academic behaviors?"),
                          tags$p("For females, there is a more direct trend that we are looking for in the visted resource factor. 
                                 ...
                                 It is not clear though whether the maximum amount of performing these factors leads to the highest grades."),
                          ...
                          tags$p("To recieve a low performance grading (scoring of 1) participation levels range from 29-141 times participated.
                                 ...
                                 It it evident that there is a higher frequency of participation required to recieve the highest performance grading level, and the reverse is true as well 
